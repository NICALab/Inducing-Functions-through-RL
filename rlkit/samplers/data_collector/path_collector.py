...
from rlkit.samplers.rollout_functions import rollout, rolloutM0


class MdpPathCollectorM0(PathCollector):
    def __init__(
            self,
            env,
            policy,
    ...
    def collect_new_paths(
        ...
        while num_steps_collected < num_steps:
            ...
            path = self._rollout_fn(
                ...
                preprocess_obs_for_policy_fn=self._env.obs_to_image_obs,
            )
