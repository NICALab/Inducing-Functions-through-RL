...
from rlkit.torch.networks.custom import BaselineVCifar
import rlkit.torch.pytorch_util as ptu
from rlkit.data_management.env_replay_buffer import EnvReplayBufferRandom
from rlkit.launchers.launcher_util import setup_logger
from rlkit.samplers.data_collector import MdpPathCollectorM0
from rlkit.torch.torch_rl_algorithm import TorchBatchRLAlgorithm
from env_survive.env_survive_real_v import EnvSurvive, vision_map, action_map, load_data
...
def experiment(variant):
    ...
    qf = BaselineVCifar(raw_vision=raw_vision, raw_status=raw_status)
    target_qf = BaselineVCifar(raw_vision=raw_vision, raw_status=raw_status)
...
if __name__ == "__main__":
    ...
    if raw_vision:
        if raw_status:
            ...
            exp_prefix = 'cifar10_vision_only'
    else:
        exp_prefix = 'task_a'
    if raw_status:
        exp_id = 0
